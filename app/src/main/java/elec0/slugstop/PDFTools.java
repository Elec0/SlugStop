...
public class PDFTools {
    ...
    public static void downloadAndOpenPDF(final Context context, final String pdfUrl) {
        ...
        final ProgressDialog progress = ProgressDialog.show(context, "Loading Progress", "Downloading content", true);
    ...
    public static void askToOpenPDFThroughGoogleDrive(final Context context, final String pdfUrl) {
        new AlertDialog.Builder(context)
                .setTitle("Dialog Question")
                .setMessage("Open PDF in Google Drive?")
    ...
    public static final void openPDF(Context context, File file) {
        Intent i = new Intent(Intent.ACTION_VIEW);
        // From https://medium.com/@ali.muzaffar/what-is-android-os-fileuriexposedexception-and-what-you-can-do-about-it-70b9eb17c6d0
